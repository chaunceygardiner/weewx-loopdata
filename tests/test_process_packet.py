...
class ProcessPacketTests(unittest.TestCase):
    ...
    def test_installer_commented_defaults(self):
        ...
        # NEIGHBOR's: delete log_success's comment, sit it directly under
    ...
    # clean tree.
    A_TRACKED_FILE = 'bin/user/loopdata.py'

    # PER-REPO.
    NOT_OURS = (
        'LICENSE',
        'tests/weewx.conf.us',
        'tests/weewx.conf.metric',
        'tests/weewx.conf.db-us.report-metric',
        'tests/weewx.conf.db-metric.report-us',
    )
    ...
    # arrives.
    LANG_DIR = 'skins/LoopData/lang/'
    LANG_IN_ENGLISH = 'skins/LoopData/lang/en.conf'
