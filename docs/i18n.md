...
**German, French and Dutch ship with the skin** — `skins/LoopData/lang/de.conf`
and `lang/fr.conf` (both native-speaker reviewed) and `lang/nl.conf`
(Beta awaiting its review)
